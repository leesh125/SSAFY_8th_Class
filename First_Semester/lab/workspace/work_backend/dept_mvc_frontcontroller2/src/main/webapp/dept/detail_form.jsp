...
<body>
	...
	<div class="container">
		...
		<% } %>
		<form method="post" action="${root}/dept/modify.do?deptno=${dept.deptNo }" class="row">
			<table class="table">
				<tbody>
					<tr>
				...
				<tfoot>
					<tr>
						<td colspan="2">
							...
							<input type="submit" value="삭제" formaction="${root}/dept/delete.do?${dept.deptNo}" formmethod="get"/>
