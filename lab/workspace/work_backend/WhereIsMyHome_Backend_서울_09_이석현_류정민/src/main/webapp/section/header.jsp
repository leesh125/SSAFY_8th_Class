      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>아파트/지역 조회</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="${root}/apt/apt_info.jsp">실거래가 조회</a></li>
              <li><a href="${root}/area/area_add.jsp">관심지역 추가</a></li>
              <li><a href="${root}/area/area_building.jsp">관심지역 조회</a></li>
              <li><a href="${root}/area/area_air_pollution.jsp">환경정보 조회</a></li>
            </ul>
          </li>
          <li><a class="nav-link scrollto" href="#footer">Contact</a></li>
          <c:choose>
			<c:when test="${not empty sessionScope.userId}">
				<li style="color:#1bb1dc;">${userId}님 로그인중</li>
